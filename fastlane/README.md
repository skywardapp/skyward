...
(Minor and patch are bounded at 999 and major at 2100 so the fields can't carry
into each other — see RELEASE.md; a tag outside that range is rejected rather
than built.)
